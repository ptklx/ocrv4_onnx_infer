...
# parser.add_argument(
#     "--model_dir", default=r"D:\file\ocr_detect\PaddleOCR\paddle_weight\ocrv4_nb\ocrv4_opt_det.nb", type=str, help="Non-combined Model dir path")

# parser.add_argument(
#     "--model_dir", default=r"D:\file\ocr_detect\PaddleOCR\paddle_weight\ocrv4_nb\ocrv4_opt_cls.nb", type=str, help="Non-combined Model dir path")
parser.add_argument(
    "--model_dir", default=r"D:\file\ocr_detect\PaddleOCR\paddle_weight\ocrv4_nb\ocrv4_opt_rec.nb", type=str, help="Non-combined Model dir path")

# parser.add_argument(
#     "--model_dir", default=r"D:\file\ocr_detect\PaddleOCR\paddle_weight\ocrv4_nb210\ocrv4_cls_210.nb", type=str, help="Non-combined Model dir path")
# parser.add_argument(
#     "--input_shape",
#     default=[1, 3, 224, 224],
#     nargs='+',
...
parser.add_argument(
    "--image_path", default=r"D:\file\ocr_detect\snapshot\20240511\testeret.jpg", type=str, help="The path of test image file")
parser.add_argument(
