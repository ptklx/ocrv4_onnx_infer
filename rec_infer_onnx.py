...
def main(rec_model_dir,cls_model_dir,image_dir,rec_char_dict_path):
    image_file_list = get_image_file_list(image_dir)
    text_recognizer =TextRecognizer(rec_model_dir,rec_char_dict_path,batch_num=1)
    ...
    for im_p in image_file_list:
        ...
        img_crop_list = []
        dt_boxes=[]
        dt_boxes.append(np.array([[1,1],[ori_img.shape[1]-2,1],[ori_img.shape[1]-2,ori_img.shape[0]-2],[1,ori_img.shape[0]-2]]))
        # if False:
...
if __name__ == "__main__":
    ...
    # image_dir=r"D:\file\ocr_detect\snapshot\20240511\rec_img_1"
    image_dir=r"D:\file\ocr_detect\snapshot\20240511\rec_img"
    # rec_char_dict_path="./ppocr/utils/ppocr_keys_v1.txt"
    rec_char_dict_path='D:\\file\\ocr_detect\\PaddleOCR2Pytorch\\pytorchocr\\utils\\ppocr_keys_v1.txt'
    main(rec_model_dir,cls_model_dir,image_dir,rec_char_dict_path)